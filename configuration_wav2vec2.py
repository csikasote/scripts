...
class Wav2Vec2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        use_adapter_ffn_layer=False,
        use_adapter_attn_layer=False,
        **kwargs,
    ):
        ...
        self.use_adapter_ffn_layer = use_adapter_ffn_layer
        self.use_adapter_attn_layer = use_adapter_attn_layer
