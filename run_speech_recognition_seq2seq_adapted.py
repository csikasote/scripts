...
class DataTrainingArguments:
    ...
    adapter_class: str = field(
        ...
        metadata={"help": "The class of adapters for Whispers."},
    )
    adapter_name: str = field(
        default="lora",
        metadata={"help": " The name of the adapter for whisper."},
    )
...
def main():
    ...
    # Adapter Details
    model.add_adapter(data_args.adapter_class, config=data_args.adapter_name)
    model.train_adapter(data_args.adapter_class)
