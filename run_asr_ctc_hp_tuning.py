...
def main():
    ...
    if model_args.freeze_feature_encoder:
      model_init().freeze_feature_encoder()
    ...
    def hp_space(trial: optuna.Trial) -> Dict[str, Union[float, str]]:
      return {
    ...
    if training_args.do_train:
        ...
        train_result = trainer.hyperparameter_search(n_trials=10, direction="minimize", hp_space=hp_space)
        #trainer.save_model()
